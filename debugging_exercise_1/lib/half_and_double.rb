...
def half_and_double(array)
    new_array = array.map do |num|
        if num % 2 == 0
             num / 2     # removed explciit return to allow the loop to continue running, debugger was immediately exiting upon reaching this point. This helped me to identify this as the source of the problem.
        else
            num * 2       # see above
        end
    end
